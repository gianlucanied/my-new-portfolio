...
const messages = {
  en: {
    ...
    contacts: "Contacts",
    testoPresentazione:
      "💁🏻‍♂️ I'm a Jr. Full Stack Web Developer, ambitious and passionate about the Tech world in all its facets. I have just successfully completed the Boolean Academy course, where I gained skills in the main development technologies for both <b>Frontend</b> and <b>Backend</b>. <br/>💪🏻 With a solid foundation of technical knowledge and a strong predisposition for teamwork, I am ready to tackle challenging projects in the field of software development. Currently, I am attending an academy for IT consulting with the aim of deepening my study of Java SE and Java EE.",
    pBackend:
