...
const messages = {
  en: {
    ...
    contacts: "Contacts",
    testoPresentazione:
      "💁🏻‍♂️ I am currently a Product Owner at <b>AirBanker</b>, a startup dedicated to financial consulting and education. In this role, I manage the design and implementation of the platform's key features, driving my commitment to effective digital solutions. As a Full Stack Developer, I combine my passion with solid skills in the tech industry, cultivated through an intensive program at the <b>Boolean Academy</b>, where I gained proficiency in the main Frontend and Backend development technologies. I also completed an academy with <b>ITconsulting</b>, where I strengthened my knowledge of Java SE and Java EE, focusing on Back-End development.",
    pBackend:
  ...
  it: {
    ...
    contacts: "Contatti",
    testoPresentazione:
      "💁🏻‍♂️ Attualmente sono Product Owner per <b>AirBanker</b>, una startup dedicata alla consulenza e formazione finanziaria. In questo ruolo, gestisco la progettazione e implementazione delle funzionalità principali della piattaforma, portando avanti il mio impegno verso soluzioni digitali efficaci. Come Full Stack Developer, unisco passione e competenze solide nel settore tech, coltivate attraverso un percorso intensivo alla <b>Boolean Academy</b>, dove ho acquisito padronanza nelle principali tecnologie di sviluppo Frontend e Backend. Ho inoltre completato un’academy con <b>ITconsulting</b>, dove ho consolidato le mie conoscenze in Java SE e Java EE, con un focus sul Back-End. ",
    pBackend:
