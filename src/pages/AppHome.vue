...
<template>
  ...
  <section class="home" id="home">
    ...
    <div class="home-content">
      ...
      <div class="hero-badge-row">
        <div class="hero-badge"><i class="fa-solid fa-check"></i> {{ $t("heroBadge1") }}</div>
        <div class="hero-badge"><i class="fa-solid fa-check"></i> {{ $t("heroBadge2") }}</div>
        <div class="hero-badge"><i class="fa-solid fa-check"></i> {{ $t("heroBadge3") }}</div>
      </div>
    </div>
  </section>
      ...
      <div v-for="p in clientProjects" :key="p.titleKey" class="client-card">
        ...
        <div class="client-card-body">
          ...
          <div class="client-links">
            ...
            <a v-if="p.github" :href="p.github" target="_blank" class="btn btn-sm btn-ghost-sm">
  ...
  <section class="contacts" id="contacts" data-aos="fade-up">
    <div class="contacts-inner">
      ...
      <h2 class="contacts-title" v-html="$t('contactsTitle').replace('\n', '<br>')"></h2>
...
.skill-chip {
  ...
  padding: 8px 16px; border-radius: 40px; border: 1px solid;
...
/* ── SWIPER ── */
.mySwiper { width: 200px; height: 260px; }
...
.contacts-email {
  ...
  font-size: 2rem; font-weight: 700; color: var(--main-color);
...
.contacts-social-link {
  ...
  color: rgba(230,237,243,0.5); font-size: 1.3rem; font-weight: 600;
  letter-spacing: 0.08em; text-transform: uppercase; transition: 0.3s ease;
}

.contacts-social-link i {
  font-size: 2.4rem; width: 50px; height: 50px;
  border: 1px solid rgba(255,140,0,0.25); border-radius: 50%;
